...
public enum CustomArmorMaterial implements ArmorMaterial
{
    ...
    private CustomArmorMaterial(String name, int durabilityMultiplier, int[] slotProtections, int enchantmentValue, SoundEvent sound, float toughness, float knockbackResistance, Supplier<Ingredient> p_40481_) {
        this.name = name;
    ...
    public String getName() {
        return CustomArmorModelMain.MOD_ID + ":" + this.name;
    }
